//! Codec utilities for serializing and deserializing Raft types
//!
//! This module provides utilities for serializing Raft data structures
//! (entries, hard state, conf state, snapshots) to/from bytes for storage.

use crate::error::{RaftError, Result};
use raft::prelude::{ConfState, Entry, HardState, Message, Snapshot};
...
/// Serialize a Raft entry to bytes
...
/// Deserialize a Raft entry from bytes  
...
/// Serialize a Raft hard state to bytes
...
/// Deserialize a Raft hard state from bytes
...
/// Serialize a Raft conf state to bytes
...
/// Deserialize a Raft conf state from bytes
